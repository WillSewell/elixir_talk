defmodule ElixirTalk do
  ...
  @type result :: {:inserted, non_neg_integer} | {:buried, non_neg_integer} | {:expected_crlf} | :job_to_big | :darining | connection_error
  @vsn 1.0
  ...
  @spec watch(pid, bitstring) :: {:watcing, non_neg_integer} | connection_error
  ...
  """
  @spec ignore(pid, bitstring) :: {:watching, non_neg_integer} | :not_ingored | connection_error
  ...
  @spec stats(pid) :: Keyword | connection_error
  def stats(pid) do
  ...
  @spec stats_job(pid, non_neg_integer) :: Keyword | :not_found | connection_error
  ...
  @spec stats_tube(pid, bitstring) :: Keyword | :not_found | connection_error
  ...
  @spec release(pid, non_neg_integer, Keyword) :: :released | :buried | :not_found | connection_error
